...
| I recognise words but cannot use them | [Vocabulary Evidence Card](vocabulary-audit.md) | [Vocabulary](../threads/part-1/2-vocabulary.md) | It cannot replace contextual performance with card counts |
